...
import csv
import random
from protein_predict_model_a import protein_model
import time
import sys
...
class data_processor:
    ...
    def impute(self,rna_name, prot_name, onto_name, model, sess, out_prot_fname):
        print("Imputing...")
...
argv = sys.argv[1:]
if(len(argv)<3): print("usage: imputation.py rna_file prot_file out_file [context_file]")
...
trainer.impute(rna_fname, prot_fname, onto_fname, model, sess, out_prot_fname)
print('Done')